...
let
  sources = {
    ...
    "@types/jest-28.1.5" = {
      ...
      version = "28.1.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/jest/-/jest-28.1.5.tgz";
        sha512 = "TLAC2zXxGnohSP3GxgIyJn7yrTeRPDEyVFyCY1NE2wzg392auI+69uk5EPGjUXuhkq/K208J/TWpLG7J8ebIEQ==";
      };
    };
    "@types/node-18.0.4" = {
    ...
    "ts-jest-28.0.6" = {
      ...
      version = "28.0.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/ts-jest/-/ts-jest-28.0.6.tgz";
        sha512 = "yLAWoaSJ6c9o+IT7+nyutp5uvwGzhMYb/LD5WEQAi2tBq4ZSAPay4Lf69pP/IU+GFYg87pdg5eADSzuNAFSK4g==";
      };
    };
    "ts-node-10.9.1" = {
      name = "ts-node";
